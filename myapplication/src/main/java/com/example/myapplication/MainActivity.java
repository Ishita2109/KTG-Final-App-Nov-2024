...
import android.widget.Toast;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter adapter = new ArrayAdapter(context,android.R.layout.simple_spinner_item, subjects);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sub1.equalsIgnoreCase("select subject") | sub2.equalsIgnoreCase("select subject") |
                    ...
                    Toast.makeText(context, "Please select different subject in each field.", Toast.LENGTH_SHORT).show();
...
//                        will go to career path screen after 1.5 sec
    ...
    public void ShowProgress() {
        ...
        pDialog = ProgressDialog.show(context,"Please wait", "While we are recommending best career path for you.",true);
        new Thread() {
            public void run() {
                try{
                    sleep(1500);  //1.5 Second
                    Intent myIntent = new Intent(context, CareerPathActivity.class);
